...
// const MissionVision = () => {
//   return (
//     <section className="relative w-full py-24 bg-gradient-to-b from-gray-50 to-gray-100 overflow-hidden">

//       {/* Floating Background Shapes */}
//       <div className="absolute -top-32 -left-32 w-96 h-96 bg-red-300 rounded-full blur-3xl opacity-30"></div>
//       <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-blue-300 rounded-full blur-3xl opacity-30"></div>
...
//           {/* Mission Card */}
//           <div className="group bg-white/70 backdrop-blur-lg border border-white/40 rounded-2xl shadow-xl p-10 transition duration-500 hover:shadow-2xl hover:-translate-y-2">

//             <span className="bg-red-600 text-white px-4 py-1 rounded-full text-xs font-semibold tracking-wider">
//               OUR MISSION
//             </span>

//             <h3 className="text-3xl font-bold mt-4 mb-6 text-gray-800">
//               Inspiring Lifelong Learning
//             </h3>
...
//             <span className="bg-blue-600 text-white px-4 py-1 rounded-full text-xs font-semibold tracking-wider">
//               OUR VISION
//             </span>
